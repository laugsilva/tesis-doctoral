...
%
\begin{equation}
sign_{3D} = sign([\vect{\pt}_{trk} \times \vect{\pt}_{jet}]\cdot[\vect{\pt}_{trk} \times \vect{\Delta r}_{IP} ]).
\end{equation}
%
