...
\vspace{1.5cm}
\emph{\textbf{Palabras clave:}} Experimento ATLAS, Jets, Subestructura de Jets, QCD, Producci\'on de jets $b$,  Etiquetado de Jets $b$.
\end{abstract}
...
\vspace{1.5cm}
\emph{\textbf{Keywords:}} ATLAS Experiment, Jets, Jet Substructure, $b$-jet Production, QCD, Gluon Splitting, $b$-tagging.
\end{abstract}
