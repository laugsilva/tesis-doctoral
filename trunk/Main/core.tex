...
The labeling was done in the same procedure as in the Full ATLAS analysis.

Figures (FIGURES HERE) show the distributions and correlations of most of the tracking variables, for single and merged $b$-jets, in bins of the jet $\pt$.

- Ntrk, trkwidth, drmax, tau1, tau2, tau3, drktaxis: for single  and merged jets in bins of pt, in some cases for both R=0.4 and R=0.6, and for the 4 types of inputs.
- Correlations: Tau1/Tau2 vs drktaxis, Tau1/Tau2 vs DR(B,B), Tau2 vs Tau1.
- Event displays of single and merged jets showing constituents for different pt's.
...
For the b jets, tau1, tau2, and deltaR12 are all small which is expected for a pencil-like jet.  For the g>bb jets, tau1, tau2 and deltaR12 are all large, which is typical of a gluon jet.  But the correlations are really fascinating in the g>bb sample.  tau1 and deltaR12 are nearly linearly related, which is expected if there are two hard lobes of energy.  But tau2 is almost independent of deltaR12, meaning that regardless of where the axes are, the energy is uniformly distributed around them.
...
\begin{figure}[tp]
\centering
\includegraphics[width=0.49\textwidth]{FIGS/VarsSingleMerged/DisplacedTracks/ntrk_singlemerged_AllandDisplaced_80-120.pdf}
\includegraphics[width=0.49\textwidth]{FIGS/VarsSingleMerged/DisplacedTracks/ntrk_singlemerged_AllandDisplaced_260-310.pdf}
...
\begin{figure}[tp]
\centering
\includegraphics[width=0.49\textwidth]{FIGS/VarsSingleMerged/DisplacedTracks/trkWidth_singlemerged_AllandDisplaced_80-120.pdf}
\includegraphics[width=0.49\textwidth]{FIGS/VarsSingleMerged/DisplacedTracks/trkWidth_singlemerged_AllandDisplaced_260-310.pdf}
