...
and the extent of each event's contribution, $h$, can be calculated adaptively as a function of the local densitiy of events. $h$ is the bandwidth of the kernel, also termed the \emph{smoothing parameter}.
...
A decision tree (BDT) is a binary tree structured classifier similar to the one sketched in Fig.~\ref{fig:BDTsketch}. 
