...
In the case of binned data into a histogram, one approch is to use a least-squares fitting technique to estimate the parameters. They are adjust to minimize
%
\begin{equation}
