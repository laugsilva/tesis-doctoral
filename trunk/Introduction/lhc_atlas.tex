...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\chapter{The ATLAS detector at the LHC}\label{chap:lhc_atlas}
...
%------------------------------------------------------------------------
\subsection{Trigger and Data Adquisition}\label{sec:TDAQ}
%------------------------------------------------------------------------
...
The region of the detector corresponding to the location where the L1 thresholds were passed $-$ so called ``region of interes'' (RoI) $-$ are then delivered to the L2 sofware algorithms.
