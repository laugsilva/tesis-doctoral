...
\begin{figure}[htbp]
  \begin{center}
   \includegraphics[width=0.45\textwidth]{JESUncertainty.png}
...
\begin{figure}[htbp]
  \begin{center}
      \includegraphics[width=0.45\textwidth]{bjetJESUncertainty.png}
...
\begin{figure}[htbp]
  \begin{center}
      \includegraphics[width=0.45\textwidth]{signedFinal.png}
...
\begin{figure}[htbp]
  \begin{center}
      \includegraphics[width=0.491\textwidth]{btaggingperformance.png}
