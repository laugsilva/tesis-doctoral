...
\begin{center}
  ...
  \vspace{1.5cm}
         {\large {\bfseries Identificaci\'on y etiquetado de jets con dos hadrones $b$ con el detector ATLAS.}}\\  %en el proceso de ``gluon splitting''
...
\renewcommand{\abstractname}{Identificaci\'on y etiquetado de jets con dos hadrones $b$ con el detector ATLAS}
\begin{abstract}
...
\renewcommand{\abstractname}{Identification and tagging of double $b$-hadron jets with the ATLAS Detector}
\begin{abstract}
