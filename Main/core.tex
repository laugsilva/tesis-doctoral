...
\chapter{Single and double \emph{\textbf{b}}-hadron jet properties}\label{ch:kinematic}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%The $\pt$ distribution for these samples is shown in Fig.~\ref{fig:JXpt}a. 
 For the Monte Carlo $\pt$ distribution (or the distribution of any other observable)  to be compared to that in experimental data, events from the different samples need to be weighted by their respective production cross sections. 
The (raw) generated distributions are shown in Fig.~\ref{fig:JXptNW}. The $\pt$ spectrum obtained after weighting is displayed in Fig.~\ref{fig:JXpt}, showing that a smooth distribution is obtained, with an even population of events over the whole $\pt$ range.

\begin{figure}[tp]
\centering
\includegraphics[width=0.9\textwidth]{JXspectrum_NoWeights.pdf}
%\includegraphics[width=0.49\textwidth]{JXspectrum.pdf}
...
\begin{figure}[tp]
\centering
%\includegraphics[width=0.49\textwidth]{JXspectrum_NoWeights.pdf}
...
it is not the result of a compensation.
