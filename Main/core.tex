...
%------------------------------------------------------------------------
 internal structure of $b$-jets containing two $b$-hadrons
The results presented in this chapter concern the properties of jets containing $b$-hadrons. Therefore, it is of great importance to select genuine tracks belonging to $b$-jets. 

The $b$-tagging performance relies critically on the accurate reconstruction of the charged tracks in the ATLAS Inner Detector.  The actual tagging is performed on the sub-set of tracks in the event that are associated to jets.
The jet direction is used to associate the charged particles reconstructed as tracks in the inner detector to the jet.  
