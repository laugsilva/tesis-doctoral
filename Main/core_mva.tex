...
An artificial Neural Network (NN) is a nonlinear discriminant. It can be viewed as mapping from a space of input variables $x_1,...,x_n_{var}$ onto, in the case of a signal-versus-background discimination problem, a one-dimensional output variable. 
