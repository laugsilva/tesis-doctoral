...
and the result is in agreement with the predictions made by {\sc Pythia} on a sample with the same level o of enrichedment.  % (PODRIAMOS DECIR QUE LA FRACCION DE FLAVOR CREATION ESTA BIEN SIMULADA POR PYTHIA)
